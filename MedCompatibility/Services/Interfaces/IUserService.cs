...
public interface IUserService
{
    ...
    Task<List<activesubstance>> GetUserAllergiesAsync(int userId);
    Task AddUserAllergyAsync(int userId, int substanceId);
    Task RemoveUserAllergyAsync(int userId, int substanceId);
}