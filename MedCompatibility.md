...
MedCompatibility/Converters/StringNotNullOrEmptyConverter.cs
...
MedCompatibility/MedCompatibility.md
...
MedCompatibility/Pages/Shared/Popups/ApprovalPendingPopup.xaml
MedCompatibility/Pages/Shared/Popups/ApprovalPendingPopup.xaml.cs
MedCompatibility/Pages/Shared/Popups/ChooseRolePopup.xaml
MedCompatibility/Pages/Shared/Popups/ChooseRolePopup.xaml.cs
...
MedCompatibility/Pages/Shared/Popups/InteractionsDetailsPopup.xaml
MedCompatibility/Pages/Shared/Popups/InteractionsDetailsPopup.xaml.cs
...
MedCompatibility/Pages/Shared/Popups/PatientBlockedPopup.xaml
MedCompatibility/Pages/Shared/Popups/PatientBlockedPopup.xaml.cs
...
MedCompatibility/Pages/Shared/Popups/SelectFromListPopup.xaml
MedCompatibility/Pages/Shared/Popups/SelectFromListPopup.xaml.cs
...
MedCompatibility/Platforms/Android/MedCompatAuthCallbackActivity.cs
...
MedCompatibility/Services/DoctorStatsService.cs
...
MedCompatibility/Services/Interfaces/IDoctorStatsService.cs
...
MedCompatibility/ViewModels/Shared/GoogleOAuthTest.cs
...
## File: MedCompatibility/Converters/StringNotNullOrEmptyConverter.cs
````csharp
namespace MedCompatibility.Converters;
...
## File: MedCompatibility/Pages/Shared/Popups/ApprovalPendingPopup.xaml
````
<?xml version="1.0" encoding="utf-8" ?>
<toolkit:Popup
...
## File: MedCompatibility/Pages/Shared/Popups/ApprovalPendingPopup.xaml.cs
````csharp
using CommunityToolkit.Maui.Views;
...
## File: MedCompatibility/Pages/Shared/Popups/ChooseRolePopup.xaml
````
<?xml version="1.0" encoding="utf-8" ?>
<toolkit:Popup
    CanBeDismissedByTappingOutsideOfPopup="True"
...
## File: MedCompatibility/Pages/Shared/Popups/ChooseRolePopup.xaml.cs
````csharp
using CommunityToolkit.Maui.Views;
...
## File: MedCompatibility/Pages/Shared/Popups/InteractionsDetailsPopup.xaml
````
<?xml version="1.0" encoding="utf-8" ?>
<toolkit:Popup
    CanBeDismissedByTappingOutsideOfPopup="True"
    Color="Transparent"
    x:Class="MedCompatibility.Pages.Shared.Popups.InteractionsDetailsPopup"
    xmlns="http://schemas.microsoft.com/dotnet/2021/maui"
    xmlns:models="clr-namespace:MedCompatibility.Models"
    xmlns:toolkit="http://schemas.microsoft.com/dotnet/2022/maui/toolkit"
    xmlns:x="http://schemas.microsoft.com/winfx/2009/xaml">
        ...
        <Grid RowDefinitions="Auto, Auto, *, Auto" RowSpacing="16">
            ...
            <VerticalStackLayout Grid.Row="0" Spacing="8">
                <Label
                    ...
                    FontSize="20"
                    HorizontalOptions="Center"
                    Text="⚠️ Обнаружены взаимодействия"
                    TextColor="{StaticResource TextPrimary}"
                    x:Name="TitleLabel" />
                <Label
                    FontSize="14"
                    HorizontalOptions="Center"
                    Text="Найдено 3 взаимодействия"
                    TextColor="{StaticResource TextSecondary}"
            ...
            <ScrollView Grid.Row="2">
                <CollectionView SelectionMode="None" x:Name="InteractionsList">
                    <CollectionView.ItemsLayout>
                            ...
                            <Border
                                ...
                                <VerticalStackLayout Spacing="8">
                                    ...
                                    <Border
                                        ...
                                        <Border.Triggers>
                                            <DataTrigger
                                                Binding="{Binding RiskLevel.Severity}"
                                                TargetType="Border"
                                                Value="1">
                                        ...
                                        <Label FontAttributes="Bold" FontSize="11">
                                            <Label.Triggers>
                                                <DataTrigger
                                                    ...
                                                    <Setter Property="Text" Value="🟢 Незначительный риск" />
                                                </DataTrigger>
                                                <DataTrigger
                                                    Binding="{Binding RiskLevel.Severity}"
                                                    TargetType="Label"
                                                    Value="2">
                                                    <Setter Property="TextColor" Value="#F9A825" />
                                                    <Setter Property="Text" Value="🟡 Умеренный риск" />
                                                </DataTrigger>
                                                <DataTrigger
                                                    Binding="{Binding RiskLevel.Severity}"
                                                    TargetType="Label"
                                                    ...
                                                    <Setter Property="Text" Value="🟠 Значительный риск" />
                                                </DataTrigger>
                                                <DataTrigger
                                                    Binding="{Binding RiskLevel.Severity}"
                                                    TargetType="Label"
                                                    Value="4">
                                                    <Setter Property="TextColor" Value="#D84315" />
                                                    <Setter Property="Text" Value="🔴 Высокий риск" />
                                                </DataTrigger>
                                                <DataTrigger
                                                    Binding="{Binding RiskLevel.Severity}"
                                                    TargetType="Label"
                                                    ...
                                                    <Setter Property="Text" Value="🔴 Критический риск" />
                                                </DataTrigger>
                                            </Label.Triggers>
                                        </Label>
                                    </Border>
                                    ...
                                    <Label
                                        FontSize="11"
                                        IsVisible="{Binding Recommendation, Converter={StaticResource StringNotNullOrEmptyConverter}}"
                                        LineBreakMode="WordWrap"
...
## File: MedCompatibility/Pages/Shared/Popups/InteractionsDetailsPopup.xaml.cs
````csharp
using CommunityToolkit.Maui.Views;
using MedCompatibility.Models;
...
## File: MedCompatibility/Pages/Shared/Popups/PatientBlockedPopup.xaml
````
<?xml version="1.0" encoding="utf-8" ?>
<toolkit:Popup
    Color="Transparent"
...
## File: MedCompatibility/Pages/Shared/Popups/PatientBlockedPopup.xaml.cs
````csharp
using CommunityToolkit.Maui.Views;
...
## File: MedCompatibility/Pages/Shared/Popups/SelectFromListPopup.xaml
````
<?xml version="1.0" encoding="utf-8" ?>
<toolkit:Popup
    CanBeDismissedByTappingOutsideOfPopup="True"
...
## File: MedCompatibility/Pages/Shared/Popups/SelectFromListPopup.xaml.cs
````csharp
using CommunityToolkit.Maui.Views;
...
## File: MedCompatibility/Services/DoctorStatsService.cs
````csharp
using System.Threading.Tasks;
using MedCompatibility.Models;
using MedCompatibility.Services.Interfaces;
...
## File: MedCompatibility/Services/Interfaces/IDoctorStatsService.cs
````csharp
namespace MedCompatibility.Services.Interfaces;
...
## File: MedCompatibility/ViewModels/Shared/GoogleOAuthTest.cs
````csharp
...
<ContentPage
    ...
    <ContentPage.Resources>
        <ResourceDictionary>
            <converters:StringFirstCharConverter x:Key="StringFirstCharConverter" />
        </ResourceDictionary>
    </ContentPage.Resources>
                        ...
                        <CollectionView.ItemTemplate>
                            <DataTemplate x:DataType="models:user">
                                <Border
                                    ...
                                    <Border.GestureRecognizers>
                                        <TapGestureRecognizer Command="{Binding Source={RelativeSource AncestorType={x:Type ContentPage}}, Path=BindingContext.OpenPatientCommand}" CommandParameter="{Binding .}" />
                                    </Border.GestureRecognizers>

                                    <Grid ColumnDefinitions="50,*,Auto" ColumnSpacing="16">
                                        ...
                                        <Border
                                            ...
                                            <Label
                                                ...
                                                FontSize="20"
                                                HorizontalOptions="Center"
                                                Text="{Binding LastName, Converter={StaticResource StringFirstCharConverter}}"
                                                TextColor="{StaticResource Primary}"
                                                VerticalOptions="Center" />
                                        </Border>
...
<ContentPage
    ...
    <Grid>
        ...
        <!--  Основная сетка  -->
        <Grid Padding="16,10" RowDefinitions="Auto,*">
            ...
            <ScrollView Grid.Row="1" Margin="0,10,0,0">
                <VerticalStackLayout
                    ...
                    <Border
                        ...
                        <VerticalStackLayout Spacing="16">
                            ...
                            <Label
                                FontSize="14"
                                HorizontalTextAlignment="Center"
                                Text="Войдите в аккаунт, чтобы получить доступ к истории проверок и назначениям врача."
                                TextColor="{StaticResource TextSecondary}" />
                    ...
                    <!--  Пользователь  -->
                    <VerticalStackLayout IsVisible="{Binding IsUser}" Spacing="0">
                            ...
                            <VerticalStackLayout Spacing="16">
                                ...
                                <VerticalStackLayout Spacing="6">
                                    <Label
                                        ...
                                        Text="Фамилия"
                                        TextColor="{StaticResource TextSecondary}" />
                                    <Border Style="{StaticResource MedInputContainer}">
                                        <Entry
                    ...
                    <!--  Отступ снизу  -->
                    <BoxView Color="Transparent" HeightRequest="60" />
                </VerticalStackLayout>
            </ScrollView>
        </Grid>
    </Grid>
...
<ResourceDictionary
    ...
    <!--  Заголовок формы  -->
    <Style TargetType="Label" x:Key="FormTitleLabelStyle">
    ...
    <LinearGradientBrush EndPoint="0,1" StartPoint="0,0" x:Key="AppBackgroundBrush">
...
## File: MedCompatibility/MedCompatibility.md
````markdown
This file is a merged representation of the entire codebase, combined into a single document by Repomix.
    ...
    <ContentPage.Resources>
        <ResourceDictionary>
            ...
            <Style TargetType="material:ButtonView" x:Key="ActionTile">
                ...
                <!--  Убираем Fill — чтобы плитки не "уезжали" влево  -->
    ...
    <Grid>
        ...
        <ScrollView>
            <VerticalStackLayout
                ...
                <Grid ColumnDefinitions="*,Auto" ColumnSpacing="16">
                    <VerticalStackLayout Spacing="4">
                        <Label Style="{StaticResource HeaderLabel}" Text="Здравствуйте!" />
                        <Label Style="{StaticResource SubHeaderLabel}" Text="{Binding WelcomeText}" />
                    </VerticalStackLayout>
